...
RaceCapture logs are simply generated by starting a logging session on the racecapture. A
...
if __name__ == '__main__':
    ...
    print("Loading log...")
    with codecs.open(args.log, "r", encoding='utf-8',
    ...
    elif args.log_type == "RACECAPTURE":
        print("Extracting data...")
        data_log.from_racecapture_log(lines)
